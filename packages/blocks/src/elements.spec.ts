...
const overrideValues = (limit: number, value: string) =>
  describe('Slack Element widgets', () => {
    ...
    describe('option object', () => {
      ...
      it('truncates ellipsis for text, description on an option object', () => {
        expect.assertions(1);
        expect(
      ...
      it('truncates url on an option object', () => {
        expect.assertions(1);
        expect(
      ...
      it('disallows too long value on an option object', () => {
        expect.assertions(1);
        expect(OptionObject('Why best?', dynamicText)).toMatchSnapshot();
      });

      it('allows override on too long value on an option object', () => {
        expect.assertions(1);
        expect(OptionObject('Why best?', dynamicText)).toMatchSnapshot();
      });
    });
